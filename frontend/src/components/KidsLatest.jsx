              ...
              <div className='sliderImgDiv'>
                ...
                <div className="sliderImgBottom">
                  <div className="sliderImgBottomTop">
                    <h3 className="sliderImgTitle">Summer Cap</h3>
                    <span className="sliderImgStar">5 <FaStar /></span>
                  </div>
                  <div className="sliderImgBottomBottom">
                    <h4 className="sliderImgPrice">$12.00</h4>
                  </div>
                </div>
              </div>
              <div className='sliderImgDiv'>
                ...
                <div className="sliderImgBottom">
                  <div className="sliderImgBottomTop">
                    <h3 className="sliderImgTitle">Classic Kid</h3>
                    <span className="sliderImgStar">5 <FaStar /></span>
                  </div>
                  <div className="sliderImgBottomBottom">
                    <h4 className="sliderImgPrice">$30.00</h4>
                  </div>
                </div>
              </div>
              <div className='sliderImgDiv'>
